 ...
 *
 * @author JOHN MENDOZA
 * Escriba ubn programa que contenga nuemros enteros, mostrar la relacion de nuemeros, la suma, el promedio, el mayor y el menor valro
 */
public class Ejercicio_25_05_1 {
